...
The **Item Purchase Counter** is a new setting introduced in **v1.5.0**. It allows you to track how many of a specific item (or group of items) a player has purchased across **any** Mart event.
<br/>
Set it up like this:
<br/>
```ruby
