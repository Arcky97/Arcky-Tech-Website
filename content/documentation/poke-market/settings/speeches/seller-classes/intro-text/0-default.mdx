...
<br/>
As show in the example below, you can include multiple variations. The script will randomly choose one line from the array each time the player interacts with the NPC.
<br/>
