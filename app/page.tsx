      ...
      <section className="w-7/8 lg:w-6/8">
        ...
        <div className="flex flex-wrap justify-center gap-8 p-4">
          {[
            ...
            <div
              key={index}
              className="bg-gray-800 p-6 rounded-lg shadow-lg w-[100%] sm:w-[47%] xl:w-[31%] 2xl:w-[23%] transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-blue-500/50 hover:ring-2 hover:ring-blue-500"
            >
