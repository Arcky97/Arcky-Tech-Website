...
export const mention: MarkdownRule = {
  ...
  react: (node, output, state) => (
    <span
      key={state.key}
      className={`rounded-[3px] px-0.5 font-medium transition-colors duration-50 ease-in-out bg-[#5f64f2] bg-opacity-30 text-[#dee0fc] ${
        node.content === "@everyone" || node.conent === "@here"
          ? ""
