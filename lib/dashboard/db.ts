...
declare global {
  var _botDb: mysql.Pool | undefined;
  var _authDb: mysql.Pool | undefined;
}
...
export const botDb = global._botDb ?? (global._botDb = createPool(process.env.BOT_DB_NAME!));
export const authDb = global._authDb ?? (global._authDb = createPool(process.env.AUTH_DB_NAME!));