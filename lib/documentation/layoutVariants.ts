type StyleGroup = 'default' | 'updateHistory' | 'contentSection';
...
export function getStyles(slug: string[], layout: StyleGroup): StyleConfig {
  const base = baseStyles[layout] || baseStyles['default'];
  return {
    ...base
  };
}